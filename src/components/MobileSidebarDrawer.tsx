  ...
  return (
    <>
      ...
      <button
        ...
        className="fixed top-3 left-3 z-40 inline-flex items-center justify-center w-10 h-10 rounded-xl vision-glass border border-white/60 shadow-md text-slate-700 hover:text-slate-900 active:scale-95 transition"
